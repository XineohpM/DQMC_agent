...
_BASE_SCRIPT_CATALOG: tuple[ScriptDefinition, ...] = (
    ...
    ScriptDefinition(
        ...
        "Compute specific heat from beta-scan energy derivative or fluctuation observables.",
        "analysis",
        "writes_output",
        _script("scripts/compute_specific_heat.py"),
        args_schema={
            "required": ["path", "mode"],
            "properties": {
                "path": _path_prop("--path", role="input"),
                "subdir_pfx": {"flag": "--subdir_pfx"},
                "output_pfx": {"flag": "--output_pfx"},
                "tp": {"flag": "--tp"},
                "mode": {"flag": "--mode"},
            },
        },
